                        ...
                        <tbody>     
                            <tr v-for="(value, index) in campaigns" :key="index">
                                ...
                                <td class="options-cell">
                                    ...
                                    <a href="javascript:void(0)" @click="value.renderDefault == null ? '':copyCampaign(value.id)" :disabled="value.renderDefault == null" :class="(value.renderDefault == null ? 'btn-secondary mr-2':'btn-warning mr-2')" data-toggle="tooltip" data-placement="top" :title="$languages.copyButtonText"><i class="icon-clone"></i></a>
